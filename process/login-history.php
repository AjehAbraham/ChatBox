...
$permision = "granted";
$status = "online";
$insert = "INSERT INTO Login_history(UniqueID,User_id,Login_status,SessionID
,Permission,Time,Ip_add,User_agent)

VALUES('$_SESSION[uniqueID]','$_SESSION[session]','$status','$sessionID',
'$permision','$time','$ip','$user_agent')
